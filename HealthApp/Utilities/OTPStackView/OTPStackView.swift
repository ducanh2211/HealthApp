...
class OTPStackView: UIStackView {
    ...
    let textBackgroundColor = UIColor.rgba(255, 255, 255, 1)
    let activeFieldBorderColor = UIColor.rgba(44, 134, 103, 1)
    ...
    private final func setupTextField(_ textField: OTPTextField){
        ...
        textField.textColor = UIColor.rgba(4, 12, 34, 1)
    ...
    private final func checkForValidity(){
        for fields in textFieldsCollection{
            if (fields.text?.trimmingCharacters(in: .whitespaces) == ""){
